...
public class Controller {
    ...
    public void initialize() {
        ...
        */
            ...
            public ListCell<Student> call(ListView<Student> param) {
                ListCell<Student> cell = new ListCell<Student>() {
                    ...
                    protected void updateItem(Student stu, boolean empty) {
                        /* ensure that the studentListView has studId's or not when
        ...
        note to self, come back to this after getting the items to load into the list view
        */
    ...
    public void deleteStudent(Student stu) {
         ...
         */
        //insert the line of code here
        alert.setHeaderText(String.format("Deleting student %s", stu.getStudId()));
